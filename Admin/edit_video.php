...
$fetch=mysqli_fetch_assoc(mysqli_query($conn,"SELECT * FROM `add_video` WHERE `id`='".$_GET['edit']."' "));
                ...
                <div class="card-body row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="Text" id="inputName" name="video_name" value="<?php echo $fetch['video_name'];?>" class="form-control" />
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
    ...
    <div class="form-group">
        ...
        <select class="form-control" id="tags" name="tag_id">
            ...
            <?php } ?>
                            ...
                            <!--        <input type="file" id="inputName" name="video" class="form-control" /><br>-->
                            <!--        <video width="320" height="240" controls>-->
                            <!--        <source src="../images/<?php // echo $fetch['video']; ?>" type="video/mp4">-->
                            <!--        </video>-->
                            <!--    </div>-->
                            <!--</div>-->
                          <div class="col-12">
