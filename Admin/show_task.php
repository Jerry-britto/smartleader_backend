...
if (isset($_GET['delete_id'])) {
    $sqlDELETE = mysqli_query($conn, "DELETE FROM `add_task` WHERE `id`='" . $_GET['delete_id'] . "'");
    echo "<script>alert('deleted ..!!');window.location.href='show_task.php';</script>";
}
?>
<!-- DataTables -->
    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Tasks Users</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Show Tasks User</h3>
            </div>
            <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <?php
                        $n = 1;
                        $query = mysqli_query($conn, "SELECT * FROM `add_task`");
